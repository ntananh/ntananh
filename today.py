...
USER_NAME = os.environ['USER_NAME'] # 'ntananh'
...
if __name__ == '__main__':
    ...
    # e.g {'id': '69842271'} and 2020-08-18T08:05:20Z for username 'ntananh'
    user_data, user_time = perf_counter(user_getter, USER_NAME)
    OWNER_ID, acc_date = user_data
    formatter('account data', user_time)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2001, 6, 9))
    ...
    if OWNER_ID == {'id': '69842271'}: # only calculate for user ntananh
